...
ActiveRecord::Schema.define(version: 20180313180401) do
  ...
  create_table "reward_periods", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "shop_id"
